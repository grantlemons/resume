...
\section{Personal Projects}
    \resumeSubHeadingListStart
        ...
        \resumeSubItem{Advisory Creator}
            {Multi-tier application to intelligently create and manage groups of students and advisors using Svelte, Rust, and AWS.}
    ...
    \resumeSubHeadingListStart
        \item{
            ...
            \hspace{.5cm}\small Issued: Aug. 2022\\
            \hspace{.5cm}\small Expires: Aug. 2025\\
            \hspace{.5cm}\small Credential ID: S8XVNC12QBF41B57\\
        }
    \resumeSubHeadingListEnd
